...
//     event EthAmount(uint256 amount);
//     event InitialSupply(uint256 initialSupply);
//     event LockedLiquidityPercentage(uint256 lockedLiquidityPercentage);
//     event TokenCreator(address TokenCreator);
...
//         emit EthAmount(ethAmount);
//         emit InitialSupply(initialSupply);
//         emit LockedLiquidityPercentage(lockedLiquidityPercentage);
//         emit TokenCreator(tokenCreator);
//         if (ethAmount == 0) {
