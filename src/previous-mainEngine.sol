...
//         _addInitialLiquidity(tokenAddress, initialSupply, msg.value, lower, upper, initialSupply, msg.value);
...
//     function getLastUpdateInfo() public view returns (uint256, address) {
//         return (lastUpdateTimestamp, lastUpdater);
//     }

//     function checkHealth() public view returns (string memory) {
//         if (block.timestamp - lastUpdateTimestamp > 1 days) {
//             return "Unhealthy: No updates in the last 24 hours";
//         }
//         return "Healthy";
//     }
//     ////////////////////////////////////
...
//         return _createToken(name, symbol, description, imageUrl, twitter, telegram, website, initialSupply);
//     }
//     // Add this function to the MainEngine contract
...
//         uint256 p = (uint256(sqrtPriceX96) * uint256(sqrtPriceX96) * 10 ** 18) / (q * q);

//         uint256 precision_p = p * 10 ** tokenDecimals / 1e18;
